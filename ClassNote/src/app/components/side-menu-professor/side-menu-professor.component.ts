...
@Component({
  selector: 'app-side-menu-professor',
  templateUrl: './side-menu-professor.component.html',
  styleUrls: ['./side-menu-professor.component.scss'],
})
export class SideMenuProfessorComponent implements OnInit {
